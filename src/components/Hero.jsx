...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="page-shell relative flex flex-col items-center gap-8 py-16 text-center sm:gap-10 sm:py-20 lg:py-24">
        {/* Subtitle */}
        <motion.p
        ...
        >
          <div className="relative aspect-[16/9] w-full overflow-hidden rounded-2xl bg-[#e9e7e1] shadow-[0_40px_80px_-30px_rgba(0,0,0,0.25)] sm:aspect-[21/9]">
            <img
              src={watch}
